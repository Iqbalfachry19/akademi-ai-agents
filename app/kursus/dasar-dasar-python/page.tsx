    ...
    <div className="container mx-auto px-4 py-12">
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          ...
          <p className="mb-4">
            Kursus "Dasar-dasar Python" dirancang untuk memperkenalkan Anda pada
            fundamental bahasa pemrograman Python, dengan fokus pada aplikasi
            dalam AI dan Data Science. Anda akan mempelajari sintaks dasar,
            struktur data, dan konsep pemrograman yang diperlukan untuk memulai
            perjalanan Anda dalam AI dan Data Science.
          </p>
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>
              Minggu 6: Pengenalan Modul Python untuk Data Science (NumPy,
              Pandas)
            </li>
          </ul>
        </div>
