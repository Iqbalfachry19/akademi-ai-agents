...
export default function LargeLanguageModelsPage() {
  return (
    <div className="container mx-auto px-4 py-12">
      <h1 className="text-3xl font-bold mb-8 text-center">Large Language Models (LLM)</h1>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <div>
          ...
          <p className="mb-4">
            Kursus "Large Language Models (LLM)" dirancang untuk memberikan pemahaman mendalam tentang arsitektur,
            pelatihan, dan penerapan LLM. Anda akan mempelajari cara kerja model-model seperti GPT dan BERT, serta
            bagaimana menggunakannya dalam berbagai aplikasi.
          </p>
          ...
          <CardContent>
            <form>
              <div className="grid w-full items-center gap-4">
                ...
                <div className="flex flex-col space-y-1.5">
                  <Label htmlFor="experience">Pengalaman NLP</Label>
                  <Input id="experience" placeholder="Jelaskan pengalaman NLP Anda" />
                </div>
